  ...
  return (
    <div className="space-y-5">
      <section className="rounded-[var(--cc-radius-card)] border border-slate-200 bg-white p-5 shadow-[var(--cc-shadow-soft)]">
        <p className="text-xs font-semibold uppercase tracking-wide text-blue-600">모아보기</p>
        <h1 className="mt-1 text-2xl font-bold tracking-tight text-slate-950">인기 게시판</h1>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
          조회수가 높은 글을 모아 보여줍니다. 원본 게시글은 그대로 두고, 이 화면에서는 인기 글만 빠르게 확인할 수 있습니다.
        </p>
      </section>
      ...
      {isLoading ? (
        ...
        <div className="rounded-2xl border border-dashed border-slate-300 bg-white px-5 py-10 text-center">
          <p className="text-lg font-semibold text-slate-900">아직 인기 글이 없어요</p>
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
            글이 1000회 이상 조회되면 이 목록에 올라옵니다.
          </p>
          <Link
            href="/home"
